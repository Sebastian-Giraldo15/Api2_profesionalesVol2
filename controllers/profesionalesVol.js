...
const putProfesionales = async(req, res) =>{
    const {tipo_documento, numero_documento, nombre_profesional, apellido_profesional, fecha_nacimiento, edad, pais_nacimiento, dep_nacimiento, mun_nacimiento, genero} = req.body
    try {
